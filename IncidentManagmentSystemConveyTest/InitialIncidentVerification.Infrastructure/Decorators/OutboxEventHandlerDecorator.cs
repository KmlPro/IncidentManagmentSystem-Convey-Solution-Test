...
namespace InitialIncidentVerification.Infrastructure.Decorators
{
    //IMessageOutbox method HandleAsync wrap method in
    internal sealed class OutboxEventHandlerDecorator<TEvent> : IEventHandler<TEvent> where TEvent : class, IEvent
    {
